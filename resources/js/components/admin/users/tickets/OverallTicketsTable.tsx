...
export function OverallTicketsTable({ tickets }: OverallTicketsTableProps) {
    return (
        <Card className="shadow-sm flex flex-col">
                                            ...
                                            {ticket.assigned_user ? (
                                                <>
                                                    ...
                                                    <div className="text-xs text-muted-foreground">
                                                        {ticket.assigned_user.company ?? 'No Company'} • {ticket.assigned_user.group ?? 'No Group'}
                                                    </div>
                                                </>
                                            ) : (
            ...
            {tickets.meta.links && tickets.meta.links.length > 3 && (
